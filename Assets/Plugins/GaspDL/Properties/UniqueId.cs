...
public class UniqueId : MonoBehaviour
{
    ...
    static Dictionary<string, UniqueId> _allGuids = new Dictionary<string, UniqueId>();
    ...
    void Update()
    {
        ...
        bool anotherComponentAlreadyHasThisID = (uniqueId != null &&
            _allGuids.ContainsKey(uniqueId) &&
            _allGuids[uniqueId] != this);
        ...
        // it in our list
        if (!_allGuids.ContainsKey(uniqueId))
        {
            _allGuids.Add(uniqueId, this);
        }
    }
